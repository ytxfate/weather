...
def get_web_info():
    ...
    for web_url in web_urls:
        ...
        time.sleep(1)
        # break
    # print(json.dumps(cities_weather, ensure_ascii=False))
    # 将提取的数据存入json文件中
    # cities_weather_json = json.dumps(cities_weather, ensure_ascii=False)
    with open('./cities_weather.json', 'w', encoding='utf-8') as f:
        json.dump(cities_weather, f, ensure_ascii=False)
        print("数据提取完成。")
